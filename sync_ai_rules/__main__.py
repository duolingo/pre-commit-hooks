...
_GITATTRIBUTES_START = "# sync-ai-rules:start"
_GITATTRIBUTES_END = "# sync-ai-rules:end"


def _write_gitattributes(project_root: str, patterns: List[str]) -> None:
    """Write a demarcated section in .gitattributes marking generated files."""
    lines = [
        _GITATTRIBUTES_START,
        "# Auto-generated by sync-ai-rules hook. Do not edit this section.",
    ]
    for pattern in patterns:
        lines.append(f"{pattern} linguist-generated")
    lines.append(_GITATTRIBUTES_END)
    content = "\n".join(lines) + "\n"

    file_path = os.path.join(project_root, ".gitattributes")
    success, message = update_documentation_file(
        file_path, content, (_GITATTRIBUTES_START, _GITATTRIBUTES_END)
    )
