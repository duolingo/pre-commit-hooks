...
class SkillsGenerator(OutputGenerator):
    ...
    def generate_files(self, rules: Dict[str, List[RuleMetadata]], project_root: str) -> None:
        ...
        _write_gitattributes(skills_root)

    def get_section_markers(self) -> tuple[str, str]:
        return ("", "")


def _write_gitattributes(skills_root: str) -> None:
    """Write a .gitattributes that hides generated skills from GitHub PR diffs."""
    gitattributes_path = os.path.join(skills_root, ".gitattributes")
    content = (
