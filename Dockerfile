...
wget https://repo1.maven.org/maven2/com/squareup/sort-gradle-dependencies-app/0.17/sort-gradle-dependencies-app-0.17-all.jar -O gradle-dependencies-sorter
